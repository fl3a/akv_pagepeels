...
1)
Place the 'akv_pagepeels' folder at /sites/all/modules 
or example.com/modules.

2)
Enable 'AKV Pagepeels' under admin/build/modules.  

3) (optional)
Configure 'akv_pagepeels' under admin/settings/akv_pagepeels.	  
